        ...
        return (
                <div className="BrandAI-form">
                    ...
                    <form name="tagline-form">
                        ...
                        <label
                            className={!this.state.hasTagline ? 'BrandAI-radio-btn selected' : 'BrandAI-radio-btn'}
                        ...
                        <div className={ this.state.hasTagline ? 'show' : 'no-show' } style={{marginTop: '30px'}}>
                            ...
                            <button onClick={ e =>{
                               ...
                               this.props.history.push('/industry');
                                    ...
                                    className={ this.state.tagline.length > 0 ? 'BrandAI-btn' : 'BrandAI-btn btn-disabled' }
                        ...
                        <button
                            className={!this.state.hasTagline ? 'BrandAI-btn' : 'no-show'}
