          ...
          <div className="BrandAI-form">
              ...
              <form name="industry_name">
                        <div>
                            ...
                            <textarea onChange={this.handleInputChange} className="BrandAI-textarea" autoFocus={true} name="company_description" id="" cols="30" rows="10" placeholder="We sell pizzas and italian sandwiches to hungry customers in downtown Boston, Massachusetts. We want our logo to be modern and playful with bright colors."></textarea>
                        </div>

                        <button className={this.state.companyDescription.length > 0 ? 'BrandAI-btn' : 'BrandAI-btn btn-disabled'} style={{marginTop: '30px'}} onClick={ e =>{
                              e.preventDefault();
